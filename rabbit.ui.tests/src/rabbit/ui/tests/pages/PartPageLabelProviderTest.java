...
public class PartPageLabelProviderTest {
  ...
  public void testGetForeground() {
    ...
    assertEquals(Display.getDefault().getSystemColor(SWT.COLOR_DARK_GRAY),
        provider.getForeground(undefinedPart));
  }
