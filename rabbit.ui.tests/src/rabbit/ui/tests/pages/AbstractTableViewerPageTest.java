 ...
 */
public abstract class AbstractTableViewerPageTest extends
  ...
  protected IContentProvider createContentProvider(AbstractTableViewerPage page)
      throws Exception {
  ...
  protected void restoreState(AbstractTableViewerPage page) throws Exception {
    Method restoreState = AbstractTableViewerPage.class
  ...
  protected void saveState(AbstractTableViewerPage page) throws Exception {
    Method saveState = AbstractTableViewerPage.class
