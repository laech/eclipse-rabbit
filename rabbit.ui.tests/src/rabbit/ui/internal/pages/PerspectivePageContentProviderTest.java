...
public class PerspectivePageContentProviderTest {
  ...
  private final IPerspectiveDescriptor perspective = new UndefinedPerspectiveDescriptor(
      System.nanoTime() + "");
  ...
  public void testGetChildren() throws Exception {
    ...
    PerspectiveDataDescriptor d1 = new PerspectiveDataDescriptor(
        new LocalDate(), new Duration(1), "id");
  ...
  public void testGetElement() throws Exception {
    // Two data descriptor of different dates, same id, different value:
    PerspectiveDataDescriptor d1 = new PerspectiveDataDescriptor(
        new LocalDate(), new Duration(1), perspective.getId());
    PerspectiveDataDescriptor d2 = new PerspectiveDataDescriptor(
        d1.getDate().minusDays(1), new Duration(1), d1.getPerspectiveId());
  ...
  public void testGetMaxValue() {
    // Two data descriptor of different dates, same id, different value:
    PerspectiveDataDescriptor d1 = new PerspectiveDataDescriptor(
        new LocalDate(), new Duration(100), "id");
    PerspectiveDataDescriptor d2 = new PerspectiveDataDescriptor(
    ...
    // Perspective
    // Set to Category.PERSPECTIVE so that the two data descriptors representing
    // the same perspective will be merged as a single tree node:
    provider.setSelectedCategories(Category.PERSPECTIVE);
  ...
  public void testGetSelectedCategories() {
    ...
    ICategory[] categories = new ICategory[]{
        Category.DATE, Category.PERSPECTIVE};
  ...
  public void testSetPaintCategory() {
    // Two data descriptor of different dates, same id, different value:
    PerspectiveDataDescriptor d1 = new PerspectiveDataDescriptor(
        new LocalDate(), new Duration(11111), "id");
    PerspectiveDataDescriptor d2 = new PerspectiveDataDescriptor(
        d1.getDate().minusDays(1), new Duration(2), d1.getPerspectiveId());
