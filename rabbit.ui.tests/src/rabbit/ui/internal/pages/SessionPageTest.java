...
public class SessionPageTest extends AbstractFilteredTreePageTest {
  ...
  public void testGetValue() throws Exception {
    SessionDataDescriptor des = new SessionDataDescriptor(new LocalDate(), new Duration(10));
    assertEquals(des.getDuration().getMillis(), ((IValueProvider) page).getValue(des));
  }
