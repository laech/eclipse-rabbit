...
import static rabbit.tracking.storage.xml.DatatypeConverter.*;
...
public class PerspectiveEventStorerTest
	...
	@Override protected PerspectiveEventStorer create() {
	...
	@Override protected PerspectiveEvent createEvent2() {
	...
	@Override protected List<PerspectiveEventType> getEventTypes(PerspectiveEventListType type) {
		return type.getPerspectiveEvent();
	}

	@Override protected boolean isEqual(PerspectiveEventType type, PerspectiveEvent event) {
	...
	@Override protected void mergeValue(PerspectiveEvent main, PerspectiveEvent tmp) {
