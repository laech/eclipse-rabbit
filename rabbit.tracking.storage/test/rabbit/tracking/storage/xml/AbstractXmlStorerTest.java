...
public abstract class AbstractXmlStorerTest<E extends DiscreteEvent, T, S extends EventGroupType> {
	...
	@SuppressWarnings("unchecked") protected Collection<S> getDataField(AbstractXmlStorer<E, T, S> s) throws Exception {
	...
	@Test public void testAbstractXmlStorer() {
	...
	@Test public void testIsSameMonthInYear() throws DatatypeConfigurationException {
	...
	@Test public void testNewXmlTypeHolder() {
	...
	@Test public abstract void testCommit();

	@Test public abstract void testInsert();

	@Test public abstract void testInsertCollection();

	@Test public abstract void testHasSameId_workbenchEventTypeAndEvent();

	@Test public abstract void testHasSameId_workbenchEventTypeAndWorkbenchEventType();

	@Test public abstract void testMerge_xmlListTypeAndEvent();

	@Test public abstract void testMerge_xmlListTypeAndxmlListType();

	@Test public abstract void testMerge_xmlTypeAndEvent();

	@Test public abstract void testMerge_xmlTypeAndXmlType();

	@Test public abstract void testNewXmlTypeHolderXMLGregorianCalendar();

	@Test public abstract void testNewXmlTypeT();
