 ...
 * 
 * @param <E> The event type. Such as {@link rabbit.tracking.event.CommandEvent}
 *            .
 * @param <T> The corresponding XML object type of the event type. Such as
...
public abstract class AbstractXmlStorer<E extends DiscreteEvent, T, S extends EventGroupType> implements IStorer<E> {
	 ...
	 */
	@Override public void insert(Collection<? extends E> col) {
