...
public class JaxbUtil {
	 ...
	 *             its handleEvent method or the Marshaller is unable to marshal
	 *             obj (or any object reachable from obj).
	 ...
	 * Unmarshals a file.
	 * 
	 * @param <T> The class type of the object to be unmarshaled.
	 * @param type The class of the object to be unmarsharled.
	 * @param f The file.
	 * @return The object specified by the type.
	 * @throws JAXBException If any unexpected errors occur while unmarshalling
	 * @throws UnmarshalException If the ValidationEventHandler returns false
	 *             from its handleEvent method or the Unmarshaller is unable to
	 *             perform the XML to Java binding.
