 ...
 * </pre>
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "perspectiveEventType") public class PerspectiveEventType {

	@XmlAttribute(required = true) protected String perspectiveId;
