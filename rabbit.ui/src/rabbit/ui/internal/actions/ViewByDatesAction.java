...
/**
 * Changes the displaying state on a {@link AbstractDateCategoryContentProvider}
 * 
...
public class ViewByDatesAction extends Action {
  ...
  public ViewByDatesAction(AbstractDateCategoryContentProvider provider) {
    ...
    setImageDescriptor(SharedImages.TIME_HIERARCHY);
    setChecked(provider.isDisplayingByDate());
  }

  @Override
  public void run() {
    super.run();
    provider.setDisplayByDate(isChecked());
  }
}
