...
import rabbit.ui.internal.dialogs.GroupByDialog2;
 ...
 */
public class ShowGroupByDialogAction2 extends Action {

  private ICategoryProvider2 provider;
   ...
   */
  public ShowGroupByDialogAction2(ICategoryProvider2 provider) {
   ...
   * @throws NullPointerException If the provider is null.
   */
  public ShowGroupByDialogAction2(ICategoryProvider2 provider, String text, int style) {
    super(text, style);
  ...
  public void runWithEvent(Event event) {
    ...
    GroupByDialog2 dialog = new GroupByDialog2(parentShell);
    dialog.create();
