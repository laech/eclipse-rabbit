...
/**
 * Utility class for working with the workbench. TODO
 */
public final class WorkbenchUtil {
   ...
   * @deprecated
   */
  @Deprecated public static IWorkbenchPart getActivePart() {
   ...
   */
  public static IPerspectiveDescriptor getPerspective(IWorkbenchWindow win) {
    if (win == null) {
      return null;
    }
