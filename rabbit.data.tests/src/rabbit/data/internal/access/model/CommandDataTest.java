...
public class CommandDataTest {
  ...
  public void before() {
    ...
    command = commandService().getDefinedCommands()[0];
    count = 10;
  }
  ...
  public void shouldReturnTheCommand() {
    assertThat(
        create(date, workspace, command, count).get(ICommandData.COMMAND),
        is(command));
  }
   ...
   */
  private CommandData create(LocalDate d, WorkspaceStorage ws, Command cmd,
      int count) {
