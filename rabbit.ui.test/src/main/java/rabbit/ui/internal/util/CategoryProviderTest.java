...
public class CategoryProviderTest {
  ...
  @Test(expected = IllegalArgumentException.class) public void constructorShouldThrowAnExceptionIfAllSupportedDoesNoContainAllDefaultSelectedCategories() {
    create(new ICategory[0], mock(ICategory.class));
  }

  @Test public void shouldCorrectlySetTheSelectedCategories() {
  ...
  @Test public void shouldFilterOutNotSupportedCategories() {
  ...
  @Test public void shouldNotifyObserversWhenSelectedCategoriesAreSetToDifferentCategories() {
  ...
  @Test public void shouldNotNotifyObserversIfSelectedCategoriesAreSetToTheSameCategories() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
  ...
  @Test public void shouldReturnAllSupportedCategoriesAsAnImmutableCollection() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
  ...
  @Test public void shouldReturnAllSupportedCategoriesDefinedInConstructor() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
  ...
  @Test public void shouldReturnTheCorrectUnselectedCategoriesWhenFirstConstructed() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    ICategory[] selected = {all[0]};
  ...
  @Test public void shouldReturnTheCorrectUnselectedCategoriesWhenNewCategoriesAreSet() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    ICategory[] selected = {all[0]};
    ICategory[] unselected = {all[1]};
  ...
  @Test public void shouldReturnTheSelectedCategoriesAsAnImmutableCollection() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    ICategory[] selected = {all[0]};
    CategoryProvider p = create(all, selected);
  ...
  @Test public void shouldReturnTheSelectedCategoriesBeenSet() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    CategoryProvider p = create(all);
  ...
  @Test public void shouldReturnTheSelectedCategoriesDefinedInConstructor() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    ICategory[] selected = {all[0]};
    CategoryProvider p = create(all, selected);
    assertThat(p.getSelected(), equalTo(asList(selected)));
  ...
  @Test public void shouldReturnTheUnselectedCategoriesAsAnImmutableCollection() {
    ICategory[] all = {mock(ICategory.class),mock(ICategory.class)};
    CategoryProvider p = create(all);
