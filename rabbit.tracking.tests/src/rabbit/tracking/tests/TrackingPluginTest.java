...
public class TrackingPluginTest {
	...
	private static Collection<ITracker<?>> getTrackers(TrackingPlugin target) throws Exception {
	...
	public void testCreateTrackers() throws Exception {
		Method createTrackers = TrackingPlugin.class.getDeclaredMethod("createTrackers");
	...
	public void testSetEnableTrackers() throws Exception {
		Method m = TrackingPlugin.class.getDeclaredMethod("setEnableTrackers", Collection.class,
				boolean.class);
