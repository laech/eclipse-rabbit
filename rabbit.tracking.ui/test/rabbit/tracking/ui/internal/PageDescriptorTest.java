...
public class PageDescriptorTest {
	...
	@Test public void testAddChild_self() {
		assertFalse(pageDescriptor.addChild(pageDescriptor));
	}

	@Test public void testConstructor_withDescriptionNull() {
		try {
	...
	@Test(expected = NullPointerException.class) public void testConstructor_withNameNull() {
		new PageDescriptor(null, page, description);
	}

	@Test(expected = NullPointerException.class) public void testConstructor_withPageNull() {
