...
public abstract class AbstractIdToValueAccessorTest<E, S extends EventGroupType>
   ...
   */
  protected String getId(AbstractIdToValueAccessor<E, S> accessor, E e)
      throws Exception {
    Method method = AbstractIdToValueAccessor.class.getDeclaredMethod("getId",
        Object.class);
   ...
   */
  protected long getUsage(AbstractIdToValueAccessor<E, S> accessor, E e)
      throws Exception {
    Method method = AbstractIdToValueAccessor.class.getDeclaredMethod(
        "getUsage", Object.class);
    method.setAccessible(true);
  ...
  protected Collection<E> getXmlTypes(AbstractIdToValueAccessor accessor, S s)
      throws Exception {
    Method method = AbstractIdToValueAccessor.class.getDeclaredMethod(
