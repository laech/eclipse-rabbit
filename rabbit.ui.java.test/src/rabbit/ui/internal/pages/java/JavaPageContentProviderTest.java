...
public class JavaPageContentProviderTest {
  ...
  /**
   * Note that JavaPageContentProvider accepts: JavaCategory.DATE
   * JavaCategory.PROJECT JavaCategory.PACKAGE_ROOT JavaCategory.PACKAGE
   * JavaCategory.TYPE_ROOT JavaCategory.MEMBER for structuring the data.
   */
  ...
  public void testCategories() {
    ...
    Set<JavaCategory> set = EnumSet.of(JavaCategory.DATE, JavaCategory.PROJECT,
        JavaCategory.PACKAGE_ROOT, JavaCategory.PACKAGE,
        JavaCategory.TYPE_ROOT, JavaCategory.MEMBER);
  ...
  public void testGetChildren() throws Exception {
    ...
    JavaDataDescriptor d1 = new JavaDataDescriptor(new LocalDate(),
        new Duration(12234), METHOD_ID);
    JavaDataDescriptor d2 = new JavaDataDescriptor(d1.getDate().minusDays(1),
        new Duration(123), METHOD_ID);
  ...
  public void testGetSelectedCategories() {
    ...
    ICategory[] categories = new ICategory[]{
        JavaCategory.DATE, JavaCategory.MEMBER};
  ...
  public void testGetUnselectedCategories() {
    ...
    Set<JavaCategory> unselect = Sets.difference(all,
  ...
  public void testSetSelectedCategories_emptyArray() {
    try {
      ICategory[] cats = new ICategory[]{
          JavaCategory.TYPE_ROOT, JavaCategory.PACKAGE};
      ...
      // The defaults:
      cats = new ICategory[]{
          JavaCategory.PROJECT, JavaCategory.PACKAGE_ROOT,
          JavaCategory.PACKAGE, JavaCategory.TYPE_ROOT, JavaCategory.MEMBER};
      assertArrayEquals(cats, provider.getSelectedCategories());
  ...
  public void testSetSelectedCategories() {
    ...
    cats = new ICategory[]{
        JavaCategory.TYPE_ROOT, JavaCategory.DATE, JavaCategory.PROJECT};
    provider.setSelectedCategories(cats);
    assertArrayEquals(cats, provider.getSelectedCategories());
  }
